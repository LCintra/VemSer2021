...
class Validacoes{
    ...
    validaApenasLetras(string){
        let stringSemEspacos = string.replaceAll(' ', '');
        let stringArray = [...stringSemEspacos];
        let stringArrayEhInvalido = stringArray.some(caractere => caractere.toLowerCase() === caractere.toUpperCase())
        if(stringArrayEhInvalido){
            alert('Foi inserido caracteres inválidos!')
            return true
        } else {
            return false
        }
...
const alocarColaborador = (idColaboradorAlocado,idProjetoAlocar) =>{
...
const desalocarColaborador = idColaboradorADesalocar =>{
...
const mostrarColaboradoresSemProjeto = () =>{
    //criando a mensagem
...
const mostrarProjetosSemColaboradores = () => {
    //criando a mensagem
...
const mostrarColaboradoresSemPonto = () =>{
    //criando a mensagem
...
const marcarPonto = (idColaboradorMarcarPonto,horaPonto,diaPonto) =>{
...
do{
    ...
    switch(resp){
        case '1':
            ...
            if(!new Validacoes().validaIsNotEmpty(nome) || new Validacoes().validaApenasLetras(nome)) break;
            criarColaborador(nome);
            break;
        case '2':
            //pedindo o titulo do projeto
            let titulo = prompt('Qual o título do projeto?');
            if(!new Validacoes().validaIsNotEmpty(titulo) || new Validacoes().validaApenasLetras(titulo)) break;
            criarProjeto(titulo);
            break;
        case '3':
            ...
            alocarColaborador(idColaboradorAlocado,idProjetoAlocar);
            break;
        case '4':
            ...
            desalocarColaborador(idColaboradorADesalocar);
            break;
        case '5':
            ...
            marcarPonto(idColaboradorMarcarPonto,horaPonto,diaPonto);
            break;
        case '6':
            mostrarColaboradoresSemProjeto();
            break;
        case '7':
            mostrarProjetosSemColaboradores();
            break;
        case '8':
            mostrarColaboradoresSemPonto();
            break;
        case '9':
